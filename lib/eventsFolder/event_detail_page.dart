...
class _EventDetailPageState extends State<EventDetailPage> with TickerProviderStateMixin {
    ...
    return Row(
      children: <Widget>[
        ...
        Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            Text(DateTimeUtils.getDayOfWeek(event.eventDate), style: AppTheme.title),
            UIHelper.verticalSpace(4),
            const Text("10:00 - 12:00 PM", style: AppTheme.subtitle),
          ],
        ),
        const Spacer(),
        Container(
          padding: const EdgeInsets.all(2),
          decoration: const ShapeDecoration(shape: StadiumBorder(), color: AppTheme.primaryLight),
          child: Row(
            children: <Widget>[
              UIHelper.horizontalSpace(8),
              Text("Add To Calendar", style: AppTheme.subtitle.copyWith(color: Colors.black)),
  ...
  Widget buildAboutEvent() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        const Text("About", style: AppTheme.headline),
        UIHelper.verticalSpace(),
        Text(event.description, style: AppTheme.subtitle),
    ...
    return Row(
      children: <Widget>[
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            Text(event.organizer, style: AppTheme.title),
            UIHelper.verticalSpace(4),
            const Text("Organizer", style: AppTheme.subtitle),
          ],
        ),
        const Spacer(),
        TextButton(
      ...
      child: Row(
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              const Text("Price", style: AppTheme.subtitle),
              UIHelper.verticalSpace(8),
              RichText(
                text: TextSpan(
                  children: [
                    TextSpan(
                        text: "\$${event.price}", style: AppTheme.title.copyWith(color: Theme.of(context).primaryColor)),
          ...
          ElevatedButton(
            ...
            child: Text(
              "Get a Ticket",
              style: AppTheme.title.copyWith(color: Colors.white, fontWeight: FontWeight.normal),
            ),
          ),
        ],
      ),
